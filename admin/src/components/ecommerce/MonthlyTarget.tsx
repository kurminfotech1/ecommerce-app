    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <div className="relative">
          <div className="max-h-[330px]">
            {loading ? (
              <div className="h-[330px] flex items-center justify-center">
                <div className="w-40 h-40 rounded-full border-8 border-gray-200 dark:border-gray-700 border-t-brand-500 animate-spin" />
              </div>
            ) : (
              <ReactApexChart
                options={options}
          ...
          <span
            className={`absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full px-3 py-1 text-xs font-medium ${isGrowing
              ? "bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500"
              : "bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500"
              }`}
          >
            {isGrowing ? "+" : ""}{revenueGrowthVsLastMonth}%
          </span>
        </div>
