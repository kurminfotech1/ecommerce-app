...
export const metadata: Metadata = {
  title: "Next.js Buttons | Aushadh Organic - Premium Organic & Herbal Products",
  description:
    "This is Next.js Buttons page for Aushadh Organic - Next.js Tailwind CSS Admin Dashboard Template",
};
