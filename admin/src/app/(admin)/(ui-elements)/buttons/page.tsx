...
export const metadata: Metadata = {
  title: "Next.js Buttons | Avshdh Organic - Premium Organic & Herbal Products",
  description:
    "This is Next.js Buttons page for Avshdh Organic - Next.js Tailwind CSS Admin Dashboard Template",
};
